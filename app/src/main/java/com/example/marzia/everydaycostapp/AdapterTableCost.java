...
/**
 * Created by marzia on 2/27/2018.
 */

public class AdapterTableCost extends ArrayAdapter {
    ...
    public AdapterTableCost(@NonNull Context context, ArrayList<CostCalculation> list) {
        super(context, R.layout.table_record_row_layout);
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        view=inflater.inflate(R.layout.table_record_row_layout,parent,false);
